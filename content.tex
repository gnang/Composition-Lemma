...
\end{array}\right\} 
\]
is not up to sign fixed by $\tau$. Thus pairing by this interchange $\mathscr{S}_{j}$ with $\mathscr{S}_{k}$ and vice versa. In other words $\tau(\mathscr{S}_{j})=\mathscr{S}_{k}$.
Observe that
