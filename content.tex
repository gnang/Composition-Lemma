...
\]
then for an arbitrary $f\in\mathbb{Z}_{n}^{\mathbb{Z}_{n}}$ the complementary labeling involution involution is defined as the map
\[
...
\end{equation}
we simply write $P \equiv Q$. All congruence relations in this paper are modulo the ideal generated set of polynomial prescribed above.
\end{defn}
